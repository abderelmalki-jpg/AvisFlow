  ...
  return (
    <div className="min-h-screen flex bg-fb-bg">
      ...
      <div className="hidden lg:flex lg:w-[420px] bg-fb-surface border-r border-fb-border flex-col justify-between p-10 flex-shrink-0">
        ...
        <div>
          <div className="w-10 h-10 bg-brand-500/10 text-brand-500 rounded-xl flex items-center justify-center mb-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-fb-text text-sm font-medium">Sophie Martin</p>
              <p className="text-fb-dim text-xs">Propriétaire, Bistrot du Coin</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-fb-text mb-1.5">Bon retour</h1>
            <p className="text-fb-muted text-sm">Connectez-vous à votre compte ReplyLocal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-sm font-medium text-fb-muted">Mot de passe</label>
                <a href="#" className="text-xs text-brand-500 hover:text-brand-400">Mot de passe oublié ?</a>
              </div>
